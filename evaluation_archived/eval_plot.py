...
def plot_fairness_vs_accuracy(location_name, file_name):
    ...
    # results_DGOPT = pd.read_csv(f"../evaluation/{location_name}_DG_log_optimize_loss_func.csv")
    ...
    data = {
        ...
        # f"{location_name}_DGOPT": (results_DGOPT['accuracy'], results_DGOPT['fairness'])
    }

    hull_colors = {f"{location_name}_G": "yellow", f"{location_name}_DG": "green", f"{location_name}_NLG": "orange"}
    # hull_colors = {f"{location_name}_G": "yellow", f"{location_name}_DG": "green", f"{location_name}_NLG": "orange", f"{location_name}_DGOPT": "black"}
    ...
    legend_handles = {
        ...
        # "hull_DGOPT": plt.Line2D([0], [0], marker='o', color='w', markerfacecolor='black', markersize=10, label=f"{location_name}_DGOPT"),
