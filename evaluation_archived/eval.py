...
class FlowEvaluator:
    ...
    def evaluate_fairness(self, accuracy_metric, variance_metric, demographic_column):
        ...
        # TODO: Change the folder name to match the model type
        heat_maps_path = os.path.join(path_parts[0], 'evaluation', f'{self.folder_name}_{self.model_type}_heatmaps')
        # heat_maps_path = os.path.join(path_parts[0], 'evaluation', f'{self.folder_name}_{self.model_type}_heatmaps_optimize_loss_func')
        ...
        filename += f'{accuracy_metric}_{variance_metric}_heatmap.png'
