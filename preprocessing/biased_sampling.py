...
def merge_data(features_df, demographics_df, flow_df, demographic_column_name='svi', experiment_id='0'):
    """
    ...
    - experiment_id (str): A unique identifier for the experiment. Default is '0'.
    ...
    if final_df.isna().any().any():
        ...
        diagnosis_path = f'../processed_data/{experiment_id}/train/diagnosis_sampling_missing/'
